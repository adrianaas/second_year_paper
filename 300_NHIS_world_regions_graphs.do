...
do `"$dir\301_NHIS_world_regions_models.do"'
...
foreach sheet of local sheets {
    * Step 1: Import nMx data from A1:G12 (this includes the first 11 rows)
    import excel using "301_NHIS_world_regions_lifetables_100.xlsx", ///
...
graph export "$texdir\panel1_nmx_all_native_foreign_100.jpg", width(8000) height(6000)  replace
...
graph export "$texdir\panel2_nmx_by_region_100.jpg", width(8000) height(6000) replace
...
graph export "$texdir\temp_le_scatter_region_100.jpg", width(8000) height(6000) replace
...
collect title "Temporary Life Expectancy by Region of Birth: 2000-2009. Model-Based Estimates from NHIS Data (Weighted)."
collect export "$texdir\tle1.tex", tableonly replace
...
collect title "Temporary Life Expectancy by Region of Birth: 2010-2018. Model-Based Estimates from NHIS Data (Weighted)."
collect export "$texdir\tle2.tex", tableonly replace
